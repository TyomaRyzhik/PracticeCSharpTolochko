...
class Program
{
    ...
    /// <summary>
    /// Метод для вычисления модуля разности двух чисел.
    /// </summary>
    /// <param name="a">Первое число.</param>
    /// <param name="b">Второе число.</param>
    /// <returns>Модуль разности двух чисел.</returns>
    ...
    /// <summary>
    /// Метод для вычисления модуля разности трех чисел.
    /// </summary>
    /// <param name="a">Первое число.</param>
    /// <param name="b">Второе число.</param>
    /// <param name="c">Третье число.</param>
    /// <returns>Модуль разности трех чисел.</returns>
