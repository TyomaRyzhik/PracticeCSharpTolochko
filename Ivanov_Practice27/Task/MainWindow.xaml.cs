...
namespace Task
{
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            //booksTextBox1.Visibility = Visibility.Collapsed;
        }
        ...
        {
            booksTextBox1.Visibility = Visibility.Visible;
            booksTreeView.Visibility = Visibility.Collapsed;
            booksListBox1.Visibility = Visibility.Collapsed;

            booksTextBox1.Text = string.Join(Environment.NewLine, booksListBox.Items.Cast<string>());
        }

        private void DisplayInTreeView_Checked(object sender, RoutedEventArgs e)
        {
            booksTextBox1.Visibility = Visibility.Collapsed;
            booksTreeView.Visibility = Visibility.Visible;
            booksListBox1.Visibility = Visibility.Collapsed;

            booksTreeView.Items.Clear();
            foreach (var item in booksListBox.Items)
            {
                booksTreeView.Items.Add(new TreeViewItem { Header = item });
            }
        }
        ...
        private void DisplayInListBox_Checked(object sender, RoutedEventArgs e)
        {
            booksTextBox1.Visibility = Visibility.Collapsed;
            booksTreeView.Visibility = Visibility.Collapsed;
            booksListBox1.Visibility = Visibility.Visible;

            booksListBox1.Items.Clear();
            foreach (var item in booksListBox.Items)
            {
                booksListBox1.Items.Add(item);
            }
        }
    }
}
