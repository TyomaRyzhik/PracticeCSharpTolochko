...
namespace Task4
{
    public partial class Form4 : Form
    {
        ...
        public Form4()
        {
            ...
            helpProvider.HelpNamespace = @"C:\\Users\\USER\\Desktop\\36ТП\\3 курс\\Практика Толочко\\Ivanov_Practice24\\Practice24\\Task4\\bin\\Debug\\net6.0-windows\\helpfortask4.txt"; // Замените на путь к вашему файлу справки
        ...
        {
            string filePath = helpProvider.HelpNamespace;
