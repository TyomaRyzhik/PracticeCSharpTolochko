...
namespace Task6
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeArrayControls()
        {
            ...
            // Кнопка "Заполнить"
            btnFill = new Button { Text = "Заполнить", Location = new System.Drawing.Point(350, 30) };
            btnFill.Click += BtnFill_Click;
            Controls.Add(btnFill);

            // Кнопка "Заменить"
            btnReplace = new Button { Text = "Заменить", Location = new System.Drawing.Point(350, 60) };
